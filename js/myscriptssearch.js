...
if (check === true) {
  if ((des[i].innerHTML.indexOf(neadlestring.toUpperCase()) >= 0) || (des[i].toLowerCase().innerHTML.indexOf.(neadlestring.toLowerCase()) >= 0)) || (des[i].innerHTML.indexOf(neadlestring) >= 0))  {
